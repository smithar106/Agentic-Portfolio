...
export const projects: Project[] = [
  ...
  },
  {
    slug: "coming-next",
    name: "Coming Next",
    eyebrow: "New build in progress",
    tagline: "The next AI/data product — in progress.",
    description:
      "This is a placeholder for the next project. Replace the fields below in src/data/projects.ts and it will appear in the carousel, navigation, and case-study routing automatically.",
    category: "TBD",
    featured: true,
    accent: "violet",
    status: "placeholder",
    technologies: ["TBD"],
    highlights: ["Placeholder — replace this object in src/data/projects.ts"],
    problem: "Placeholder — describe the operational problem this product solves.",
    solution: "Placeholder — describe what you built and how it works.",
    flow: [{ step: "Step", detail: "Describe the pipeline step here." }],
    decisions: [{ title: "Decision", body: "Describe a technical decision here." }],
    lessons: ["Placeholder — what did you learn building it?"],
    githubUrls: [],
  },
];
